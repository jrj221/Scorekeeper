...
export interface GameTypeDefinition {
  ...
  /**
   * Optional background tint for a scorecard cell (e.g. Phase 10's phased green/red).
   * Only called for cells that already have a score (`hasScore` true); return undefined
   * for no tint.
   */
  cellBackground?(
    game: Game,
