				...
				>
							...
							trailing={
								<View style={forms.labelRow}>
									{playersError && players.length === 0 && (
										<ThemedText style={[forms.label, { color: theme.danger }]}>
											{" "}
											REQUIRED
										</ThemedText>
									)}
					...
					{gameType === "phase10" && (
						<View style={styles.group}>
							...
							<SetupCard>
								...
								<Pills
									options={PHASE_SUBSET_PILLS}
									value={phaseSubsetChoice}
									onChange={setPhaseSubsetChoice}
								/>
					...
					<View style={{ gap: Spacing.one }}>
						...
						>
							<ThemedText
								type="smallBold"
								style={{ color: canCreate ? theme.accentText : theme.textSecondary }}
							>
								Create Game
							</ThemedText>
						</HapticButton>
